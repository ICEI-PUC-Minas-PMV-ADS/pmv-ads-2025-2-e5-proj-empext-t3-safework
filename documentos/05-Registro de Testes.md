# Registro de Testes
Este documento descreve vários testes para o projeto SafeWork desenvovlido em .Net.

## 📌 Objetivo

### Testes para os processo de Login
1- Verificar se um usuário consegue autenticar com credenciais válidas;
2- Verificar as mensagens de retorno em caso de erro;
3- Verificar os tratamentos de erros em casos de credenciais inválidas ou nulas.
...
<figure> 
  <img src="./img/ComprovanteTesteDeLogin.png" alt"Implementação dos Testes de Login">
</figure>
